...
use clap::Parser;
use counters::{DashMapCounter, HashMapCounter, HyperLogLogCounter, KmerCounter, MemoryTrackedCounter};
use rayon::prelude::*;
use serde::Serialize;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let (unique_kmers, total_kmers, count_time, total_time, peak_memory) = match args.counter {
        CounterType::HashMap => {
